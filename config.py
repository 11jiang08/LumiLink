...
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY", "") #TODO 从环境变量获取 OpenAI API 密钥
...
# ==========================================
# 4. 自训练场景分类模型（resnet18training 分支合并）
# ==========================================
# 若该文件存在，cv_perception.py 会自动加载并用于场景分类，替代 ImageNet 预训练
SCENE_MODEL_PATH = "models/scene_resnet18.pt"
